...
- (void)viewDidLoad
{
    ...
    _autoScroller = [[MSAutoScroll alloc] init];
    [_autoScroller initializeWithScrollView:self.tableView];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.textLabel.text = [self genRandStringLength:10];
    return cell;
}
